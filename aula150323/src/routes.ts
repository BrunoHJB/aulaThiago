...
routes.post('/products', productsController.writeProducts)
routes.get('/products', productsController.readProducts)
// routes.get('/products-stock', productsController.getStockValue)
